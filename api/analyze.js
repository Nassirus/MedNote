export default async function handler(req, res) {
  ...
  const PROMPT =
    'Ты медицинский ассистент. Из документа извлеки ВСЕ назначения: лекарства, процедуры, упражнения, диету, ограничения, визиты.\n' +
    'Язык полей title/dose/notes: ' + langName + '.\n' +
    'Верни ТОЛЬКО JSON-массив без пояснений:\n' +
    '[{"type":"medication|exercise|procedure|appointment|restriction|nutrition","title":"название","dose":"дозировка или null","times_per_day":1,"first_time":"08:00 или null","duration_days":null,"is_one_time":false,"notes":"примечание или null"}]\n' +
    'Если назначений нет — []. ТОЛЬКО JSON, никакого текста.'

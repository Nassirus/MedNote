export default async function handler(req, res) {
  ...
  try {
    ...
    if (!r.ok) {
      ...
      if (r.status === 429) return res.status(429).json({ error: 'Лимит Gemini API исчерпан. Подождите минуту и попробуйте снова, или проверьте план на aistudio.google.com' })

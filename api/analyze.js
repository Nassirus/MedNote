export default async function handler(req, res) {
  ...
  const LANG_INSTRUCTION = lang === 'kk'
    ? 'Барлық атауларды, дозалауды және ескертпелерді ҚАЗАҚША жаз.'
    : 'Все названия, дозировки и примечания пиши НА РУССКОМ ЯЗЫКЕ.'

  const PROMPT =
    'Extract ONLY home treatment instructions from this medical document as JSON array.\n' +
    LANG_INSTRUCTION + '\n' +
    'Each item: {"type":"medication|exercise|procedure|appointment|restriction|nutrition","title":"short name","dose":"dosage or null","times_per_day":1,"first_time":"HH:MM or null","duration_days":null,"is_one_time":false,"notes":"note or null"}\n' +

...
import {
  connectGoogleCalendar, clearToken, isConnected, syncItemsToGCal
...
export default function Profile({ items = [], onOpenReport, onOpenEvents }) {
  ...
  // ── Google Calendar ──────────────────────────────────────────────
  const [gcalLinked, setGcalLinked]   = useState(() => isConnected())

...
export default function AddItemModal({ onAdd, onClose, defaultDate, defaultTime, defaultEndTime, existingItems = [] }) {
      ...
      <div className="modal-sheet" onClick={e => e.stopPropagation()}
        ...
        {step === 1 && (
          <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
            ...
            {/* Time row — shows range if drag-selected */}
            <div>
              ...
              {defaultEndTime ? (
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
                  <input type="time" className="input" value={time} onChange={e => onTimeChange(e.target.value)} />
                  <input className="input" value={notes} onChange={e => setNotes(e.target.value)} placeholder="Заметка..." />
                </div>
              )}
            </div>
            {defaultEndTime && (
